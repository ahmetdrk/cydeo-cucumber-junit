...
public class Order_StepDefinitions {
    ...
    public void user_is_already_logged_in_and_on_order_page() {
        // getting page using the URL from configuration.properties
    ...
    public void userEntersQuantity(int arg0) {
        ...
        //imitating pressing back_space button from keyword to delete existing input
    ...
    @When("useer enters expiry date {string}")
    public void useer_enters_expiry_date(String string) {
